...
<head>
    ...
    <!-- <link rel="icon" type="image/png" href="img/website-icon.ico" /> -->
...
<body>
    ...
    <div class="main">
        ...
        <button href="" id="playbutton" onclick="startBrickGame();">
            Play Brick
        </button>
        </br>
        <div class="Keycode Instructions">
            <h4>use mouse to move left and right</h4>
        </div>
    ...
    function submit()
    {
        ...
        $sql = "INSERT INTO brickHighscores VALUES ('$name', $score)";
